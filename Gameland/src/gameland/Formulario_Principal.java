...
import url.moculo.ventas.ConfirmarVenta;
import url.moculo.ventas.DescontarProducto;
import url.modulo.compras.AgregarProducto;
import url.modulo.compras.ConfirmarCompra;
import url.modulo.estadisticas.MostrarEstadisticas;
import url.modulo.inventario.FiltroBusqueda;
import url.modulo.usuarios.MostrarUsuarios;
...
public class Formulario_Principal extends javax.swing.JFrame {
    ...
    ClienteJpaController controlclientes = new ClienteJpaController(emf);
    ...
    private void initComponents() {
        ...
        jTabbedPaneUsuarios.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jTabbedPaneUsuariosMouseClicked(evt);
            }
        });
        ...
        jLabel31.setBounds(10, 150, 130, 14);
        ...
        jPanel15.setBounds(600, 10, 370, 380);
        ...
        jTabbedPane_Compras.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jTabbedPane_ComprasMouseClicked(evt);
            }
        });
        ...
        jPanelAgregarCompraLayout.setHorizontalGroup(
            ...
            .addGroup(jPanelAgregarCompraLayout.createSequentialGroup()
                .addGroup(jPanelAgregarCompraLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jScrollPane1.setPreferredSize(new java.awt.Dimension(1000, 456));
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "CODIGO", "NOMBRE", "DESCRIPCION", "EXISTENCIA"
            }
        ));
        ...
        jPanelDetallecompraLayout.setHorizontalGroup(
            ...
            .addGroup(jPanelDetallecompraLayout.createSequentialGroup()
                ...
                .addGap(0, 0, Short.MAX_VALUE))
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanelDetallecompraLayout.createSequentialGroup()
        ...
        jTabbedPane_Compras.addTab("INVENTARIO", jPanelDetallecompra);
    ...
    public void enviarusuario(Login usuario){
        this.lg = usuario;
        if(lg.getAdministrador()==0){
            jLabel2.setVisible(false);
            jLabelCompras.setVisible(false);
            jLabelEstadísticas.setVisible(false);
    ...
    private void jTextField2KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField2KeyReleased
        ...
        if(evt.getKeyCode() == KeyEvent.VK_ENTER){
            ...
            if(control.buscarcodigo(jTextField2.getText())==null){ 
                ...
                productocompra = control.buscarcodigo(jTextField2.getText());
            }
        }
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        Integer valor = 1;
        proveedor = controlproveedor.findProveedor(valor);
        ...
        controlCompras.create(compras);
        ConfirmarCompra confirmarCompra = new ConfirmarCompra();
        AgregarProducto agregarProducto = new AgregarProducto(confirmarCompra);
        confirmarCompra.Agregarobservador(agregarProducto);
        confirmarCompra.setProducto(jTable3);
        total = 0;
        jLabel15.setText("0.00");
    ...
    private void jTextField5KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField5KeyReleased
        enable1();
        if(evt.getKeyCode() == KeyEvent.VK_ENTER){
            pventa = controlproducto.buscarcodigo(jTextField5.getText());
            if(pventa == null){
                JOptionPane.showMessageDialog(null, "NO EXISTE PRODCUTO");
    ...
    private void jTextField3KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField3KeyReleased
        // TODO add your handling code here:
        if(evt.getKeyCode() == KeyEvent.VK_ENTER){
            productocompra.setCantidad(Integer.valueOf(jTextField3.getText()));
    ...
    private void jTextField6KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField6KeyReleased
        // TODO add your handling code here:
        if(evt.getKeyCode() == KeyEvent.VK_ENTER){
            productocompra.setPrecio(Double.valueOf(jTextField6.getText()));
            llenartabla(productocompra);
            jTextField2.requestFocus();
            jTextField3.setText("INGRESE LA CANTIDAD");
            jTextField6.setText("INGRESE EL TOTAL");
        }
    ...
    private void jTabbedPaneUsuariosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabbedPaneUsuariosMouseClicked
        // TODO add your handling code here:
        if(jTabbedPaneUsuarios.getSelectedIndex() == 0){
            MostrarUsuarios mostrar = new MostrarUsuarios();
            mostrar.Tablausuarios(jTable4);
        }
    }//GEN-LAST:event_jTabbedPaneUsuariosMouseClicked

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        DefaultTableModel modelo = (DefaultTableModel) jTable4.getModel();
        int selecion = jTable4.getSelectedRow();
        System.out.println(selecion);
        if(selecion > -1){
            modificarusuario = mostrarUsuarios.retornarUsuario((int)modelo.getValueAt(selecion, 0));
            jTextFieldNombreUsuario.setText(modificarusuario.getNombre());
            jTextFieldNombreUsuario2.setText(modificarusuario.getDpi());
        }
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // Modificar el Usuario
        UsuarioJpaController controlusuarios = new UsuarioJpaController(emf);
        modificarusuario.setNombre(jTextFieldNombreUsuario.getText());
        modificarusuario.setDpi(jTextFieldNombreUsuario2.getText());
        controlusuarios.actualizarExistencia(modificarusuario);
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton12ActionPerformed
        // Nuevo proveedor
        Nuevo_Proveedor nuevo_Proveedor = new Nuevo_Proveedor();
        nuevo_Proveedor.setVisible(true);
    }//GEN-LAST:event_jButton12ActionPerformed

    private void jTextField8KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField8KeyReleased
        // TODO add your handling code here:
        if(evt.getKeyCode() == KeyEvent.VK_ENTER){
           cliente = controlclientes.buscar(jTextField8.getText());
           if(cliente == null){
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        pventa.setCantidad( Integer.valueOf(cantidad.getText()));
        llenartablaventa(pventa);
    ...
    private void jButton16ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton16ActionPerformed
        ...
        venta.setFecha(sqlStartDate);
        venta.setClienteid(cliente);
        venta.setLoginid(lg);
        venta.setTotal(totalventa);
        venta.setNfactura("1f");
        venta.setAnulada(anulada);
        controlventas.create(venta);
        ConfirmarVenta confirmarVenta = new ConfirmarVenta();
        DescontarProducto descontar = new DescontarProducto(confirmarVenta);
        confirmarVenta.Agregarobservador(descontar);
        confirmarVenta.setProducto(jTable6);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        String fechatotal = jComboBox7.getItemAt(jComboBox7.getSelectedIndex())+"-"+jComboBox6.getItemAt(jComboBox6.getSelectedIndex())+"-"+"01";
        System.out.println(fechatotal);
        try {
            fechabuscar = sf.parse(fechatotal);
            MostrarEstadisticas mostrarEstadisticas = new MostrarEstadisticas();
            mostrarEstadisticas.filtrarcompra(jTable5, fechabuscar);
    ...
    private void jTabbedPane_ComprasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabbedPane_ComprasMouseClicked
        // TODO add your handling code here:
        if(jTabbedPane_Compras.getSelectedIndex() == 2){
            FiltroBusqueda filtrarbusqueda = new FiltroBusqueda();
            filtrarbusqueda.inventarioproductos(jTable2);
        }
    }//GEN-LAST:event_jTabbedPane_ComprasMouseClicked
    ...
    private void llenartablaventa(Producto p){
        ...
        Object[] o = new Object[]{p.getNombre(), p.getDescripcion(),p.getPrecio(), p.getCantidad()};
        model.addRow(o);
        jTable3.setModel(model);
        totalventa += p.getCantidad() * p.getPrecio();
        jLabel55.setText(String.valueOf(totalventa));
        
    }
    private void llenartabla(Producto p){
        DefaultTableModel model = (DefaultTableModel) jTable3.getModel();
        Object[] o = new Object[]{p.getCodigo(), p.getDescripcion(), p.getCantidad(), p.getPrecio()};
        model.addRow(o);
        jTable3.setModel(model);
        total += productocompra.getPrecio();
